...
import { revalidateInterview } from './_machine/actions'
import { InterviewProviderClient } from './_machine/InterviewProviderClient'
...
export default async function InterviewPage({
  ...
  return (
    <InterviewProviderClient
      sessionId={sessionId}
      revalidate={revalidateInterview}
    >

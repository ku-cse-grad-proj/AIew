...
# --deploy-hook: 갱신 성공 시에만 실행되는 훅
certbot renew --webroot --webroot-path=/var/www/certbot --quiet \
    --deploy-hook "cd $PROJECT_DIR && docker compose -f docker-compose.base.yml -f docker-compose.production.yml exec -T nginx nginx -s reload"
